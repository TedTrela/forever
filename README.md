...
forever reads its options from a file config.json in its root directory.  The root directory is identified in the following order:  env var $FOREVERROOT, env var $HOME/.forever, /root/.forever
